...
serve(async (req) => {
  ...
  try {
    ...
    if (type === "tips") {
      combinedPrompt = `You are a tax expert for Indian freelancers. Provide accurate, current tax information. Always respond with valid JSON format.

Generate 4 current and relevant tax tips for Indian freelancers for financial year ${financialYear}. 
...
Generate important tax dates for Indian freelancers for financial year ${financialYear}. 
